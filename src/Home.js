		...
		<div className='home'>
			<div className='home__container'>
				...
				<div className='home__row'>
					...
					<Product
						id='49538094'
						title='Kenwood kMix Stand Mixer for Making, Stylish Kitchen Mixer with K-beater, Dough Hook and Whisk, 5 Litre Glass Bowl'
						price={239.0}
				...
				<div className='home__row'>
					<Product
						id='90829332'
						title="Samsung LC49G90SSUXEN 49' Curved LED Gaming Monitor - Super Ultra Wide Dual WQHD 5120 x 1440"
						price={1094.98}
